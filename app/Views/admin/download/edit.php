...
<div class="form-group row">
	...
	<div class="col-md-10">
		<input type="text" name="judul_download_id" class="form-control" value="<?php echo $download['judul_download_id'] ?>" required>
	</div>
</div>
...
<div class="form-group row">
	...
	<div class="col-md-10">
		<textarea name="isi_id" class="form-control konten"><?php echo $download['isi_id'] ?></textarea>
	</div>
</div>
