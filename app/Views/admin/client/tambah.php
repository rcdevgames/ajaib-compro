...
<form action="<?php echo base_url('admin/client') ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
<?php 
echo csrf_field(); 
?>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group row">
					...
					<div class="col-9">
						<input type="text" name="pimpinan" class="form-control" placeholder="Nama Pimpinan/Panggilan" value="<?php echo set_value('pimpinan') ?>">
					</div>
				</div>
