...
<div class="form-group row">
	...
	<div class="col-9">
		<input type="text" name="nama_kategori_staff_id" class="form-control" placeholder="Nama kategori_staff" value="<?php echo $kategori_staff['nama_kategori_staff_id'] ?>" required>
	</div>
</div>
...
<div class="form-group row">
	...
	<div class="col-9">
		<input type="number" name="urutan" class="form-control" placeholder="Nomor urut kategori_staff" value="<?php echo $kategori_staff['urutan'] ?>" required>
	</div>
</div>
