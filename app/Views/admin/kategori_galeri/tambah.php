		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group row">
					...
					<div class="col-9">
						<input type="text" name="nama_kategori_galeri_id" class="form-control" placeholder="Nama kategori_galeri" value="<?php echo set_value('nama_kategori_galeri_id') ?>" required>
					</div>
				</div>
